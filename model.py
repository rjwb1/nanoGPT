...
class GPT(nn.Module):
    ...
    def forward(self, idx, targets=None):
        ...
        if targets is not None:
            ...
            if self.config.output_crop is not None:
                targets = targets[:, :self.config.output_crop].contiguous()
                logits = logits[:, :self.config.output_crop, :].contiguous()
